 ...
 */}      <mesh key={props.key} name={props.item.name} selectableData={props.item} onClick={props.selectMesh} position={[props.item.position.x, props.item.position.y + 0.1, props.item.position.z]} castShadow>
